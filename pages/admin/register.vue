<template>
    <div class="login-page" v-if="allow">
        <div class="right">
        ...
        <form class="ui form" @submit.prevent="register" :class="{loading:loading}">
            <div class="header">
                 <img src="~/assets/images/logo.png" width="70px" alt="">
                 <h4 style="color:rgba(255,255,255,0.7)">Admin Registration</h4>
